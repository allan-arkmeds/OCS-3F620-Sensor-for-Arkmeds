...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Main program body (Versão Simplificada com Polling)
  ******************************************************************************
  * @attention
  *
  * Este código usa um método de polling bloqueante para ler dados da UART.
  * O objetivo é ser simples e mostrar CADA byte recebido do sensor.
  *
  ******************************************************************************
  */
...
#include <stdio.h> // Essencial para usar a função sprintf
...
/* USER CODE BEGIN 4 */
// Não precisamos da função de callback HAL_UART_RxCpltCallback aqui,
// pois não estamos usando interrupções.
/* USER CODE END 4 */
